...
class Beautyworld extends StatefulWidget {
  const Beautyworld({super.key});

  @override
  State<Beautyworld> createState() => _BeautyworldState();
}

class  _BeautyworldState extends State<Beautyworld> {
